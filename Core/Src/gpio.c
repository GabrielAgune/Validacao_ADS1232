...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin : ADC_DOUT_Pin */
  GPIO_InitStruct.Pin = ADC_DOUT_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(ADC_DOUT_GPIO_Port, &GPIO_InitStruct);
  ...
  /*Configure GPIO pin : ADC_PDWN_Pin */
  GPIO_InitStruct.Pin = ADC_PDWN_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(ADC_PDWN_GPIO_Port, &GPIO_InitStruct);
